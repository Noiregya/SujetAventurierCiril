...
public class playTest {
    ...
    public final void playTest1(){
        Aventurier aventurier = new FilePlayerBuilder().readInstructionsFromFile("test1.txt").play(carte);
    ...
    public final void playTest2(){
        Aventurier aventurier = new FilePlayerBuilder().readInstructionsFromFile("test2.txt").play(carte);
